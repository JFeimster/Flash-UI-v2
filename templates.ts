...
export const TEMPLATES = [
    ...
    {
        title: "TikTok Shop 'Viral Curse' Manager",
    ...
    {
        title: "Logistics 'Repair vs Replace' ROI",
    ...
    {
        title: "'Net-90' Opportunity Cost Calc",
    ...
    {
        title: "Gig Economy 'Survival' Wallet",
    ...
    {
        title: "Contractor 'Supply House' Checkout",
    ...
    {
        title: "Real Estate 'Wholesaler' Deal Room",
    ...
    {
        title: "Startup 'Credit Stacker' Console",
    ...
    {
        title: "Logistics 'Repair Finance' Hub",
    ...
    {
        title: "Supply Chain 'Flow' Planner",
    ...
    {
        title: "E-Com 'Ad Arbitrage' Command",
    ...
    {
        title: "'Unbankable' Credit Incubator",
    ...
    {
        title: "Construction Bid Commander",
    ...
    {
        title: "Performance Marketing Machine",
    ...
    {
        title: "Restaurant Shift Command",
    ...
    {
        title: "Subscription Churn Defender",
    ...
    {
        title: "Fintech Infrastructure Builder",
    ...
    {
        title: "Embedded Lending Console",
    ...
    {
        title: "Treasury-as-a-Service Hub",
    ...
    {
        title: "Banking-as-a-Service Marketplace",
    ...
    {
        title: "Vertical SaaS Banking Kit",
    ...
    {
        title: "Payroll-Linked Lending Portal",
    ...
    {
        title: "Invoice Financing Exchange",
    ...
    {
        title: "Expense Management Suite",
    ...
    {
        title: "Digital Banking Command Center",
    ...
    {
        title: "Niche Landing Page Factory",
        description: "Automated system for generating niche-specific landing pages.",
    ...
    {
        title: "Landing Page Wireframe Builder",
        description: "Visual wireframe generator with drag-and-drop components.",
    ...
    {
        title: "Vertical Content Automation Engine",
        description: "AI-powered content generator for creating unique, SEO optimized vertical pages.",
    ...
    {
        title: "Microsite Deployment Automation",
    ...
    {
        title: "Notion-to-Website Pipeline",
    ...
    {
        title: "SEO Keyword Matrix Generator",
    ...
    {
        title: "Vertical Performance Dashboard",
    ...
    {
        title: "Widget Integration Studio",
    ...
    {
        title: "Landing Page A/B Testing Framework",
    ...
    {
        title: "Compliance & Legal Module Generator",
    ...
    {
        title: "Self-Funded Search Pipeline",
    ...
    {
        title: "Holding Company Portfolio Tracker",
    ...
    {
        title: "Bootstrapped Growth Calculator",
    ...
    {
        title: "No-Code Tech Stack Builder",
    ...
    {
        title: "Acquisition Integration Playbook",
    ...
    {
        title: "Venture Studio Resources Hub",
    ...
    {
        title: "AI-Driven Market Opportunity Scanner",
    ...
    {
        title: "Bootstrapped Marketing Playbook",
    ...
    {
        title: "Acquisition Letter Campaign Generator",
    ...
    {
        title: "Portfolio Company Launch Checklist",
    ...
    {
        title: "Holding Company Tax Optimizer",
    ...
    {
        title: "Venture Studio Knowledge Base",
